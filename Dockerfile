...
ENV STEAMCACHE_DNS_VERSION=1 ENABLE_DNSSEC_VALIDATION=false LANCACHE_DNSDOMAIN=cache.lancache.net CACHE_DOMAINS_REPO=https://github.com/Snorfull/cache-domains.git CACHE_DOMAINS_BRANCH=master UPSTREAM_DNS=1.0.0.2
